 ...
 */
$(function(){
    $("#dateChose").on("click",function(event){
        //$(".modalDate").show();
        //$(this).removeClass("choseAlert");
        WdatePicker();
        // setTimeout(function(){
        //     $("div[lang]").animate({top:"90"});
        //     var framePlace = window.top.frames[0]; 
        //     // var divTitle = framePlace.document.getElementsByTagName("div")[1];
        //     // var divMeun = divTitle.getElementsByTagName("div")[2];
        //     // $(divMeun).css("margin-left","100px");
        // },100)
    }); 
...
var close_modal = function(){
    ...
    $("#timeChose").val("");
    $(".timeCard").removeClass('selectedCard').removeClass("invailed");
}
// var star_date = calendar[0].toString();
// var start_date = star_date.substr(0,4)+"-"+star_date.substr(4,2)+"-"+star_date.substr(6,2);
// var length = calendar.length;
// var end_date = calendar[length*1-1].toString().substr(0,4)+"-"+calendar[length*1-1].toString().substr(4,2)+"-"+calendar[length*1-1].toString().substr(6,2);
var mydate = new Date();
var todate = "" + mydate.getFullYear()+"-";
   todate += (mydate.getMonth()+1)+"-";
...
specialDates:null,
specialDays:null,
//disabledDates:invailedDate,
disabledDates:null,
disabledDays:null,
onpicking:close_modal,
onpicked:close_modal,
onclearing:close_modal,
oncleared:close_modal,
ychanging:null,
ychanged:null,
Mchanging:null,
Mchanged:null,
