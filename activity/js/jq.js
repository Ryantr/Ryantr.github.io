...
$(function(){
    var h = $(window).height();
    $(".header").css("height",0.42*h+"px");
    $(".footer_m").css("top",(h-55)+"px");
...
function downloadclick(){     
			...
			if(Terminal.platform.weixin){ 
					...
					{	openDig_m();
						$("body").append("<div class='guide'><img  src='http://static.qiezipai.cn/activity/image/2.png'></div>");}
					else
						{  	openDig_m();
							$("body").append("<div class='guide'><img  src='http://static.qiezipai.cn/activity/image/1.png'></div>");}
					 ...
					 location.href="https://itunes.apple.com/us/app/jia-zi-pai/id963638196?mt=8";	 	 
						  ...
						  $.ajax({
 							　　url:"",				　
 　								type: "GET",
 　								success:function(){location.href="http://static.qiezipai.cn/apk/download/qiezipai.apk"},
 　								error:function(){location.href="http://static.qiezipai.cn/apk/download/qiezipai.apk"}
		...
		function openDig_m(){
				$("body").append("<div id='mask' onclick='closeDig_m()'></div>");
